...
def sort_candidates(candidates: list[KickCandidate]) -> list[KickCandidate]:
    return sorted(candidates, key=candidate_sort_key)


def _best_candidate_per_auction(candidates: list[KickCandidate]) -> list[KickCandidate]:
    best_by_auction: dict[str, KickCandidate] = {}
    ...
    *,
    ...
    strategy_stmt = (
        select(
            ...
            models.strategies.c.auction_version,
    ...
    fee_burner_stmt = (
        select(
            ...
            models.fee_burners.c.auction_version,
